...
project = Project(
    title = 'domains',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://archiveteam.org/images/thumb/3/3c/.eu-logo.png/320px-.eu-logo.png" height="50px"/>
...
pipeline = Pipeline(
    ...
    WgetDownload(
        ...
        env={
            'max_seconds': str(2*24*3600),
            'max_urls': '100000',
            'max_bytes': str(200*1024**3)
        }
    ),
